...
export const metadata: Metadata = {
  title: 'Redact screenshots before sharing them with an AI chat',
  description:
    'Blur API keys, bearer tokens, and customer data out of screenshots before pasting them into Claude, Copilot, or Cursor. Snapmark is a VS Code extension that redacts on the clipboard, so the original pixels never leave your machine.',
  alternates: { canonical: '/redact-screenshots' },
};

export default function RedactScreenshots() {
  return (
    <>
      <Nav />
      <main>
        <section className="border-b border-[var(--color-border)]">
          <div className="mx-auto max-w-3xl px-6 pt-24 pb-16 sm:pt-32">
            <p className="mb-4 text-xs font-medium uppercase tracking-widest text-[var(--color-fg-muted)]">
              Snapmark · redaction workflow
            </p>
            <h1 className="text-balance text-4xl font-semibold leading-[1.1] tracking-tight sm:text-5xl">
              Redact screenshots before you share them with an AI chat.
            </h1>
            <p className="mt-6 text-lg text-[var(--color-fg-muted)]">
              ...
              chat is a chance to leak one. Snapmark is a VS Code extension that pixelates the regions you
              pick on the clipboard image itself, before the paste target ever sees it.
            </p>
        ...
        <section className="border-b border-[var(--color-border)]">
          <div className="mx-auto max-w-3xl px-6 py-20">
            <h2 className="text-3xl font-semibold tracking-tight">What gets redacted, and where</h2>
            <div className="mt-8 space-y-8 text-[var(--color-fg-muted)]">
              <div>
                ...
                <p className="mt-2">
                  Snapmark reads the clipboard image, you draw a redact rectangle, and it writes the
                  pixelated PNG back to the clipboard. The unredacted bytes never hit a file, never hit a
                  network. When you Cmd+V, the receiving tool sees the sanitised image — there is no
                  original left to leak.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-[var(--color-fg)]">Pixelate, not black-box</h3>
                <p className="mt-2">
                  The redact tool downscales and upscales the chosen region so the content is unreadable but
          ...
          <div className="mx-auto max-w-3xl px-6 py-20">
            ...
            <ul className="mt-8 space-y-4 text-[var(--color-fg-muted)]">
              ...
              <li>
                ...
                Redact the customer&rsquo;s name and email; leave the stack trace and UI state intact.
              </li>
              <li>
